...
function RainCloudIcon({ fillColor }) {
	return (
		<svg className="raincloud-icon" fill={fillColor} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
