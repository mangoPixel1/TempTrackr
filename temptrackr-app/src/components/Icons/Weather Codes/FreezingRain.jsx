...
function FreezingRain() {
	return (
		<svg className="weatherCodeIcon freezing-rain" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			<defs>
				...
				<symbol id="c" viewBox="0 0 155.2 48" overflow="visible">
					...
					<g>
						...
						<animate id="t3" attributeName="opacity" values="0; 1; 1; 0" begin="-.67s; t3.end+1s" dur="2s" keyTimes="0; .17; .83; 1" />
					</g>
				</symbol>
			</defs>

			{/* Snowflakes */}
			<use href="#c" x="24" y="13" opacity="1" />
			<use href="#c" x="112" y="24" opacity="1" />
			<use href="#c" x="80" y="72" opacity="1" />

			{/* Raindrops */}
			<path d="M166.8,353.5a14.58,14.58,0,0,0-12.8,7.25c-3.79,6.7-8.48,18.23-17.39,18.23s-13.6-11.5-17.39-18.23A14.58,14.58,0,0,0,107.49,337a14.42,14.42,0,0,0-19.19,11.17c-5.67,8.72-9.52,23.61-17.09,30.6s-15.49,5.12-23.8,6.73-16.51,8.93-18.4,16.65c-2.26,7.07-1.74,13.9,1.2,19.55l-13.11,27.17" fill="none" stroke="#bdd2d6" strokeWidth="5" />
		</svg>
	);
}
