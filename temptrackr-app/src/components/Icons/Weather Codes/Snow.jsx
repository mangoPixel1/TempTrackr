...
function Snow() {
	return (
		<svg className="weatherCodeIcon snow" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
			<defs>
				...
				<symbol id="b" viewBox="0 0 155.2 48" overflow="visible">
					...
					<g>
						<path d="M153.17,30.54l-5.78-3.3a13.74,13.74,0,0,0,0-6.47l5.79-3.31A4,4,0,0,0,154.66,12a4.08,4.08,0,0,0-5.54-1.46l-5.79,3.3a13.61,13.61,0,0,0-2.64-2,13.84,13.84,0,0,0-3-1.28V4a4.05,4.05,0,0,0-8.1,0v6.6a14.25,14.25,0,0,0-5.69,3.23l-5.78-3.29A4.08,4.08,0,0,0,122.54,12,4,4,0,0,0,124,17.46l5.78,3.3a13.74,13.74,0,0,0,0,6.47L124,30.54A4,4,0,0,0,122.54,36a4.08,4.08,0,0,0,3.52,2,4,4,0,0,0,2-.54l5.79-3.3a13.61,13.61,0,0,0,2.64,2,13.8,13.8,0,0,0,3,1.27V44a4.05,4.05,0,0,0,8.1,0V37.39a14.22,14.22,0,0,0,5.68-3.23l5.79,3.3a4,4,0,0,0,2,.54,4.08,4.08,0,0,0,3.52-2A4,4,0,0,0,153.17,30.54ZM130.56,29.2A6,6,0,0,1,128.34,21a6.1,6.1,0,0,1,5.27-3,6.16,6.16,0,0,1,3,.8A6,6,0,0,1,138.86,27,6.12,6.12,0,0,1,130.56,29.2Z" fill="#86c3db" opacity="0">
							...
							<animate id="t3" attributeName="opacity" values="0; 1; 1; 0" begin="-1.66s; t3.end+1s" dur="2s" keyTimes="0; .17; .83; 1" />
						</path>
						<animateTransform id="s3" attributeName="transform" additive="sum" type="translate" values="0 -36; 0 92;" begin="-1.66s; s3.end+1s" dur="2s" />
					</g>
				</symbol>
			</defs>
			<use xlinkHref="#a" />
